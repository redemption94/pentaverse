...
export default async function ProfilePage(props: { params: Promise<{ id: string }> }) {
  ...
  // Tragem datele ordonate cronologic (cel mai nou meci primul)
  ...
  // Sortare finală de siguranță pentru UI
        ...
        <div className="max-w-7xl mx-auto w-full flex flex-col md:flex-row items-end gap-10 relative z-10">
          ...
          <div className="flex-1">
            <div className="flex items-center gap-3 mb-4">
              <span className="bg-[#ffeb00] text-black text-[10px] font-black px-3 py-1 uppercase italic skew-x-[-12deg]">Verified Profile</span>
              <span className="text-gray-600 text-[10px] font-bold uppercase tracking-[0.3em]">SteamID: {player.steam_id}</span>
            </div>
            ...
            <div className="flex gap-8 text-gray-500 text-[10px] font-black uppercase tracking-widest">
               ...
               <span className="flex items-center gap-2"><Activity size={14}/> Combat Intel: 100%</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <main className="max-w-7xl mx-auto px-12 py-20 grid lg:grid-cols-3 gap-16">
        <div className="lg:col-span-2 space-y-12">
          <section>
             <h3 className="text-xs font-black uppercase tracking-[0.5em] text-gray-600 mb-10 flex items-center gap-3">
                <Activity size={16} className="text-[#ffeb00]" /> Official Match History (Last 10)
             </h3>
        ...
        <aside className="space-y-8">
           <div className="bg-[#ffeb00] p-10 text-black shadow-[0_0_60px_rgba(255,235,0,0.15)]">
              ...
              <button className="w-full bg-black text-[#ffeb00] py-5 font-black uppercase italic text-xs hover:bg-white transition-all">Initialize Funding</button>
           </div>
        </aside>
      </main>
    </div>
