...
import { 
  ...
  Clock, BarChart3, Award, Flame, User
} from 'lucide-react';
...
export default async function ProfilePage(props: { params: Promise<{ id: string }> }) {
  ...
  // Căutăm în baza de date după STEAM_ID
      ...
      <div className="relative h-[450px] bg-black border-b border-white/5 overflow-hidden flex items-end">
        ...
        <div className="max-w-7xl mx-auto px-6 w-full pb-16 relative z-10">
          <div className="flex flex-col md:flex-row gap-10 items-end">
            <div className="w-48 h-48 bg-black border-4 border-[#ffeb00] shadow-[0_0_50px_rgba(255,235,0,0.1)] shrink-0">
            ...
            <div className="flex-1">
              <div className="flex items-center gap-3 mb-6">
                <span className="bg-[#ffeb00] text-black text-[10px] font-[1000] px-3 py-1 uppercase italic skew-x-[-12deg]">
                  <span className="inline-block skew-x-[12deg]">Pure Steam Intel</span>
                </span>
      ...
      <main className="max-w-7xl mx-auto px-6 py-20 grid grid-cols-1 lg:grid-cols-3 gap-16">
        ...
        <aside className="space-y-8">
          ...
          <div className="bg-[#0a0a0a] border border-white/5 p-8">
            ...
            <p className="text-5xl font-[1000] italic leading-none mb-2">{player.penta_scout_score}</p>
            <p className="text-[9px] font-bold text-gray-600 uppercase">Algorithm V3 (Steam Weighted)</p>
          </div>
        </aside>
